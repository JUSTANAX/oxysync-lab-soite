...
const MOCK = {
  ...
  autopilot: {
    ...
    farmConfig:          { id: 13, name: 'Pet Farm Standard' },
    tradesDone:          12,
    maxTradersPerServer: 10,
    checkInterval: 30,
    stuckTimeout: 10,
    queue: {
      farming: 84,
    ...
    recent: [
      { username: 'roblo_acc_2914', type: 'trade_complete', time: new Date(Date.now() - 1000 * 35) },
      { username: 'roblo_acc_7102', type: 'got_pet',        time: new Date(Date.now() - 1000 * 120) },
      { username: 'roblo_acc_3471', type: 'stuck',          time: new Date(Date.now() - 1000 * 660) },
      { username: 'roblo_acc_8855', type: 'got_pet',        time: new Date(Date.now() - 1000 * 240) },
      { username: 'roblo_acc_5623', type: 'trade_complete', time: new Date(Date.now() - 1000 * 410) },
    ],
  },
  configs: [
